...
\restrict 3VeUsVA8RevxT89CteKIDCAjWfdQzr4kPgCl8rR31hZS37e5xq0MASdnQGv7RBj
...
--
-- Name: continent_code_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.continent_code_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.continent_code_seq OWNER TO postgres;

--
-- Name: continent_code_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.continent_code_seq OWNED BY public.continent.code;
...
CREATE TABLE public.country (
    ...
    CONSTRAINT country_continent_check CHECK ((continent = ANY (ARRAY['Asia'::text, 'South America'::text, 'North America'::text, 'Oceania'::text, 'Antarctica'::text, 'Africa'::text, 'Europe'::text, 'Central America'::text]))),
...
CREATE TABLE public.countrylanguage (
    ...
    CONSTRAINT countrylanguage_percentage_check CHECK (((percentage >= (0)::double precision) AND (percentage <= (100)::double precision)))
);
...
--
-- Name: continent code; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.continent ALTER COLUMN code SET DEFAULT nextval('public.continent_code_seq'::regclass);
...
2238	Jinzhou Old	CHN	Liaoning	95761
...
COPY public.continent (code, name) FROM stdin;
1	Africa
2	Antarctica
3	Asia
4	Central America
...
AFG	Afghanistan	Asia	Southern Asia	652860	1919	40000000	62	69000000.00	\N	Afghanistan	Totalitarian	\N	\N	AF
...
CRI	Costa Rica	Central America	Central America	51100	1821	4023000	75.8	10226.00	9757.00	Costa Rica	Republic	Miguel ngel Rodrguez Echeverra	584	CR
...
HND	Honduras	Central America	Central America	112088	1838	6485000	69.9	5333.00	4697.00	Honduras	Republic	Carlos Roberto Flores Facuss	933	HN
...
SMR	San Marino	Europe	Southern Europe	61	885	27000	81.1	510.00	\N	San Marino	Republic		3171	SM
...
--
-- Name: continent_code_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.continent_code_seq', 8, true);
...
--
-- Name: continent continent_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.continent
    ADD CONSTRAINT continent_pk PRIMARY KEY (code);
...
--
-- Name: countrylanguage countrylanguage_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: city city_country_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.city
    ADD CONSTRAINT city_country_fk FOREIGN KEY (countrycode) REFERENCES public.country(code);


--
-- Name: country country_capital_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.country
    ADD CONSTRAINT country_capital_fk FOREIGN KEY (capital) REFERENCES public.city(id);


--
-- Name: countrylanguage countrylanguage_country_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.countrylanguage
    ADD CONSTRAINT countrylanguage_country_fk FOREIGN KEY (countrycode) REFERENCES public.country(code);
...
\unrestrict 3VeUsVA8RevxT89CteKIDCAjWfdQzr4kPgCl8rR31hZS37e5xq0MASdnQGv7RBj
